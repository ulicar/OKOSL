...
\begin{frame}[t]
\frametitle{Opisnici izlaza i ulaza}
\begin{itemize}
  ...
  \item Zadatak
  \begin{itemize}
    \item Izlistajte podatke o datoteci \shell{/dev/stdin}
    \item Na što pokazuje?
    \item Koja je krajnja datoteka?
  \end{itemize}
\end{itemize}
\end{frame}
...
\begin{itemize}
  ...
  \begin{tikzpicture}[auto, >=latex']
    ...
    \node[plaintext]  (c) [below=1cm of b]  {/temp/lib5};
...
\begin{itemize}
  ...
  \item Primjer, provjerimo ima li duplih linija u datoteci
        \shell{/usr/share/dict/words}
  \begin{itemize}
    \item[] \shell{\$ uniq -d /usr/share/dict/words}
  \end{itemize}
\end{itemize}
\end{frame}
