...
\begin{document}
  ...
  Za rjesavanje zadatka koristite datoteke \shell{lab3-input03.dat i \shell{lab3-output03.dat}.
    ...
    \item Osim dodavanj u grupu potrebno je urediti template za \shell{home} direktorij (skel folder). Direktoriji koji svaki student treba imatu su: Documents, Github i Shared. Direktorij Shared neka bude simbolički link na direktorij \shell{/home/public}. Dozvole nad public direktorijem nek budu ista kao i od \shell{/tmp} foldera
	\end{itemize}
